    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <form method="POST" action="/create-ngadu">
                    @csrf
                    <div class="form-group row">
                        <label for="text" class="col-4 col-form-label">Judul</label>
                        <div class="col-8">
                            <input id="text" name="judul" placeholder="Judul" type="text"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="text1" name="deskripsi" placeholder="Deskripsi" type="text"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
